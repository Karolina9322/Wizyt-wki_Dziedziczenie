...
#Zastosowanie metody basecontact() w klasie bazowej BaseContact:
    print(
    person_1.__basecontact__(),"\n",
    person_2.__basecontact__(),"\n",
    person_3.__basecontact__(),"\n",
    person_4.__basecontact__(),"\n",
    person_5.__basecontact__())

    print()

#Zastosowanie metody businesscontact() w klasie biznesowej BusinessContact:
    print(
    person_1.__businesscontact__(),"\n", 
    person_2.__businesscontact__(),"\n",
    person_3.__businesscontact__(),"\n",
    person_4.__businesscontact__(),"\n",
    person_5.__businesscontact__())
